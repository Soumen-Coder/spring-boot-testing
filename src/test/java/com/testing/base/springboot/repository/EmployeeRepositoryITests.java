...
import com.testing.base.springboot.testcontainers.AbstractionContainerBaseTest;
...
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) //Disabling the in-memory database since we need MySQL to be included in integration tests and we have already configured that in application.properties file
